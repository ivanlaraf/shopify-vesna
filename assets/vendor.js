...
__webpack_require__.d(__webpack_exports__, {
  gM: () => (/* binding */ ElegantLibs),
  LE: () => (/* binding */ ElegantTheme)
});

// UNUSED EXPORTS: ElegantEvents, ElegantSettings, ElegantStrings
...
window.ElegantEvents = window.ElegantEvents || new Event();
window._ThemeEvent = window.ElegantEvents;
window.ElegantLibs.loadjs = __loadjs;
const ElegantEvents = window.ElegantEvents;
const ElegantTheme = window.ElegantTheme || {};
const ElegantSettings = window.ElegantSettings || {};
const ElegantStrings = window.ElegantStrings || {};
const ElegantLibs = window.ElegantLibs || {};
...
/* provided dependency */ var ElegantLibs = __webpack_require__(272)["gM"];
/* provided dependency */ var ElegantTheme = __webpack_require__(272)["LE"];
/* eslint-disable no-undef */
// Import styles by module
// Core API + modules:
// import Swiper, { Navigation, Pagination, Thumbs, Autoplay, EffectFade } from 'swiper/core';
...
ElegantLibs.Swiper = swiper/* default */.Z;
ElegantLibs.AnimateLoading = (main_default());
ElegantLibs.Accordion = Accordion;
ElegantTheme.Modal = modal;
ElegantTheme.scrollIntoView = (scrollIntoView_default());
ElegantTheme.Notification = new Notification();
})();
